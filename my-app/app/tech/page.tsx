...
export default function TechnologiesPage() {
  ...
  return (
    <div className='flex flex-col items-center justify-center min-h-screen text-center p-6 bg-black'>
      ...
      <div className="absolute left-1/4 w-32 h-1 bg-gradient-to-r from-yellow-500 to-transparent"></div>
      <div className="absolute right-1/4 bottom-1/4 w-32 h-1 bg-gradient-to-l from-yellow-500 to-transparent"></div>
      
      {/* Add subtle animated dots */}
      <div className="absolute top-1/3 left-1/3 w-1 h-1 bg-yellow-500 rounded-full animate-pulse"></div>
      <div className="absolute bottom-1/3 right-1/4 w-2 h-2 bg-yellow-500 rounded-full animate-pulse" style={{animationDelay: '0.5s'}}></div>
      <div className="absolute top-2/3 right-1/3 w-1 h-1 bg-yellow-500 rounded-full animate-pulse" style={{animationDelay: '1s'}}></div>
    </div>
  );
}